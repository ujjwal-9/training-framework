LOG_DIR = "uniformer_runs"
MODEL_SAVE_DIR = "/data_nas5/qer/ujjwal/models/uniformer/exp2may_aug_true"
...
model = Uniformer(
    ...
    depths = (3, 4, 4, 3),              # depth at each stage
    mhsa_types = ('l', 'l', 'g', 'l')   # aggregation type at each stage, 'l' stands for local, 'g' stands for global
