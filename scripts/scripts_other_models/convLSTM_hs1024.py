LOG_DIR = "convLSTM_run_hs1024"
MODEL_SAVE_DIR = "/data_nas5/qer/ujjwal/models/infarcts_convlstm/"
...
# In[20]:
# model.load_state_dict(torch.load("/data_nas5/qer/ujjwal/models/infarcts_convlstm/models_15april/best_model.pth"))
