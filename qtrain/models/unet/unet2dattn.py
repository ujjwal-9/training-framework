...
class UnetSeqAttn(nn.Module):
    def __init__(self, args, device):
        ...
        self.se_blocks = [SqueezeExcitation(self.args.n_slices, 10).to(device) for i in range(self.args.depth)]
    ...
    def forward(self, ct):
        ...
        output["masks"] = masks
        output["slc_logits"] = slc_logits.T
